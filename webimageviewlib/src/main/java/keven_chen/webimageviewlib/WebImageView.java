...
public class WebImageView extends WebView {
    ...
    private void getAttr(Context context, AttributeSet attrs) {
        ...
        url = ta.getString(R.styleable.WebImageView_url);
        id = ta.getResourceId(R.styleable.WebImageView_localId, -1);
        ...
        if (BuildConfig.DEBUG) Log.d("keven", "******  layout_width=" + layout_width + "  layout_height=" + layout_height + "  scaleType=" + scaleType
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (BuildConfig.DEBUG) Log.d("keven", "onMeasure   "+(MeasureSpec.getMode(widthMeasureSpec) == MeasureSpec.EXACTLY)+" , "+measureWidth
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        if (BuildConfig.DEBUG) Log.d("keven", "onLayout   "+changed+" , "+l+" , "+t+" , "+r+" , "+b);
    }

    @Override
    public boolean onInterceptTouchEvent(MotionEvent event) {
        if (BuildConfig.DEBUG) Log.d("keven", "ACTION_DOWN ========================");
            ...
            switch (action) {
                ...
                case MotionEvent.ACTION_MOVE: {
                    ...
                    if (Math.abs(dx) > touchSlop || Math.abs(dy) > touchSlop) {
                        ...
                        if (BuildConfig.DEBUG) Log.d("keven", "ACTION_MOVE =" + dx + " # " + dy + " , " + landscape + " , " + touchSlop);
                        ...
                        if (landscape && (dx > 0 && reachLeft || dx < 0 && reachRight)
                            ...
                            if (BuildConfig.DEBUG) Log.d("keven", "ACTION_MOVE ========================");
                        }
                    }
                    break;
                }
    ...
    final class JavaScriptInterface {
        ...
        public void onScroll(final String reachLeft, final String reachRight, final String reachTop, final String reachBottom) {
            ...
            if (BuildConfig.DEBUG) Log.d("keven", "onScroll  " + WebImageView.this.reachLeft + " , " + WebImageView.this.reachRight + " , " + WebImageView.this.reachTop + " , " + WebImageView.this.reachBottom);
        }
    }
        ...
        public void handleMessage(Message msg) {
            ...
            if (webImageView != null) {
                ...
                try {
                    ...
                    if (BuildConfig.DEBUG) Log.d("keven", "measureImage   " + srcWidth+" , " + srcHeight);
                    ...
                    if (BuildConfig.DEBUG) Log.d("keven", "measureImage   " + ly.width +" , " + ly.height +" , " + ratioWidth +" , " + ratioHeight);
    ...
    final class MyWebChromeClient extends WebChromeClient {
        ...
        public boolean onJsAlert(WebView view, String url, String message, JsResult result) {
            if (BuildConfig.DEBUG) Log.d("keven", "onJsAlert  "+message);
            result.confirm();
            return true;
        }
    }
    ...
    final class MyWebViewClient extends WebViewClient {
        ...
        public void onScaleChanged(WebView view, float oldScale, float newScale) {
            if (BuildConfig.DEBUG) Log.d("keven", "onScaleChanged  "+oldScale+"   "+newScale);
        }
    }
    ...
    protected void finalize() {
        if (BuildConfig.DEBUG) Log.d("keven", "finalization = " + this);
        if (localCacheFile != null && new File(localCacheFile).exists()) {
            if (BuildConfig.DEBUG) Log.d("keven", "clear = " + localCacheFile);
